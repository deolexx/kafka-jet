package com.deo.jet.office.job;
...
public class RouteDistributeJob {
    ...
    @Scheduled(initialDelay = 500, fixedDelay = 2500, timeUnit = TimeUnit.MILLISECONDS)
    private void distribute() {
        waitingRoutesService.list()
    ...
    private void sendBoardToRoute(Route route, Board board) {
        ...
        AirPort airPort = airportsProvider.findAirPortNAdRemoveBoard(board.getName());
